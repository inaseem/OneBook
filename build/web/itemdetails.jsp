    ...
    <body data-res-from="1025">
        ...
        <div class="content-wrapper pad-none">
            <div class="content-inner">
                <!-- Shop Single Section -->
                <section id="shop-single-section" class="shop-single-section pad-bottom-90">
                    <!-- Screan Reader Text -->
                    <h2 class="screen-reader-text">Shop</h2>
                    <div class="shop-single-main-wrap">
                        <div class="container">
                            <!-- Row -->
                            <div class="row">
                                <!-- Col -->
                                <div class="col-md-6">
                                    ...
                                    <div class="product-wrap">
                                        ...
                                        <div class="product-inner">
                                            <div class="zoom-gallery product-single-thumb mb-4 relative">
                                                <span class="onsale">Sale!</span>
                                                <a class="popup-img" href="${book.getImage()}" title="${book.getTitle()}">
                                                    <img src="${book.getImage()}" class="img-fluid" alt="product-img" />
                                                </a>
                                            </div>
                                        </div>
                                        <!--Product Inner Ends-->
                                ...
                                <!-- Col -->
                                <!-- Col -->
                                <div class="col-md-6 pl-5 px-sm-15">
                                    <!-- Product Wrap -->
                                    <div class="product-wrap">
                                        <!--Product Inner-->
                                        <div class="product-inner">
                                            <div class="product-details">
                                                ...
                                                <div class="product-meta">
                                                    <div class="product-tags">
                                                        <span class="tag-item">ISBN: ${book.getIsbn()}</span>
                                                    </div>
                                                </div>
                                                <div class="product-quantity my-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <t:form action="/addToCart">
                                                            ...
                                                            <input type="submit" id="quantity-submit" class="btn btn-default mt-0 ml-5 theme-btn" value="Add to cart"/>
                                                        </t:form>
                                                    </div>
                ...
                <!-- Shop Section Ends -->
                <!-- Shop Tabs Section -->
                <section class="shop-tab-section p-0">
                    <div class="container">
                        <!--Shop Tabs Wrap -->
                        <div class="row">
                            <!-- Section Title End -->
                            <div class="col-md-12">
                                <div class="tab-body tab-style-1">
                                    <div class="tab-links">
                                        <!-- Nav tabs -->
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active text-uppercase" data-toggle="tab" href="#description">Description</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- Tab panes -->
                                        ...
                                        <div class="tab-pane active" id="description">
                                            <div class="tab-pane-content">
                                                <div class="tab-title-wrap">
                                                    <h4 class="tab-title font-w-600">Description</h4>
                                                </div>
